...
mongoose.connect("mongodb://localhost:27017/Banking_TSF_DB", {
...
const defaultUserNames = ["Megha", "Bhagya", "Nandu", "Varun","Ram", "Sharath", "Naveen", "Parvathi", "Jagadeesha", "Yash"];
const defaultUsersEmail = ["megha@gmail.com", "bhagi@gmail.com", "nandu@gmail.com", "varun@gmail.com", "ram@gmail.com", "sharath@gmail.com", "naveen@gmail.com", "paru@gmail.com", "jaggi@gmail.com", "yash@gmail.com"];
const defaultUsersAddress = ["Vizag, Andhra Pradesh", "Bangalore, Karnataka", "Vijayawada, Andhra Pradesh", "Kurnool, Andhra Pradesh", "Hederabad, Telangana", "Mehrauli, New Delhi"];

const defaultUsers = [];
for (let i = 0; i < defaultUserNames.length; i++) {
    if (defaultUserNames[i] === "Megha" || defaultUserNames[i] === "Bhagya" || defaultUserNames[i] === "Nandu" || defaultUserNames[i] === "Parvathi") {
